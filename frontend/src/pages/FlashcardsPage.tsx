    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">Upload content to generate interactive flashcards.</p>
        </div>
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8 pb-32">
      <div className="animate-slide-up">
        <h1 className="font-heading text-4xl font-bold text-foreground">Flashcard Mastery</h1>
        <p className="text-muted-foreground mt-1">Reviewing: <span className="text-primary font-bold">{currentSession.title}</span></p>
      </div>
      <FlashcardsTab flashcards={flashcardData} />
    </div>
  );
}
